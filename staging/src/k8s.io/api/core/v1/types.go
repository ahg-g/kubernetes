...
type PodAffinityTerm struct {
	...
	// nil or empty namespaces list and nil namespaceSelector means "this pod's namespace"
	// +optional
	...
	// nil selector and nil or empty namespaces list means "this pod's namespace"
